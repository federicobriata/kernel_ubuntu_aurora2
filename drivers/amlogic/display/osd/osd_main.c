...
static ump_secure_id (*ump_dd_secure_id_get)(ump_dd_handle mem) = 0xbf012718;
static ump_dd_handle (*ump_dd_handle_create_from_phys_blocks)(ump_dd_physical_block * blocks, unsigned long num_blocks) = 0xbf0139e8;
